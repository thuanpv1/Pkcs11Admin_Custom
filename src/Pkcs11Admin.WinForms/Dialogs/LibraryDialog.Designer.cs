...
namespace Net.Pkcs11Admin.WinForms.Dialogs
{
    partial class LibraryDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LabelPkcs11Library.Text = "Chon file thu vien PKCS#11 {0}:"; // Relative name or absolute path of {0} PKCS#11 library
            // 
            ...
            this.CheckBoxOverwriteLogFile.Text = "Ghi de len file nhat ky hien co"; // Overwrite existing log file
            ...
            this.LabelLogFile.Text = "Ghi nhat ky vao file:"; // Absolute path of the log file
            // 
            // LabelPkcs11Logger
            // 
            ...
            this.LabelPkcs11Logger.Text = "Chon file thu vien ghi nhat ky PKCS#11 {0}:"; // Relative name or absolute path of {0} PKCS#11 logging library
            // 
            // groupBox3
            // 
            ...
            this.CheckBoxEnableLogging.Text = "Cho phep ghi Log"; // Enable logging
            ...
            this.Text = "Chon thu vien PKCS#11"; // Load PKCS#11 library
